MODULE par_pisces
   ...
   INTEGER, PUBLIC ::   jpdcu     !: CAM Cu model
   INTEGER, PUBLIC ::   jpcun
   INTEGER, PUBLIC ::   jpcud
   INTEGER, PUBLIC ::   jpcup
   INTEGER, PUBLIC ::   jpcug
   INTEGER, PUBLIC ::   jpscup
   INTEGER, PUBLIC ::   jpscug
   INTEGER, PUBLIC ::   jpdco     !: dissolved Co
   INTEGER, PUBLIC ::   jpcon
   INTEGER, PUBLIC ::   jpcod
   INTEGER, PUBLIC ::   jpcop
   INTEGER, PUBLIC ::   jpcog
   INTEGER, PUBLIC ::   jpsco!  Cam Zn Model
   INTEGER, PUBLIC ::   jpdzn      !: Dissolved Zn
   INTEGER, PUBLIC ::   jpznn      !: Zn n nano
   INTEGER, PUBLIC ::   jpznd      !: Zn in diatoms
   INTEGER, PUBLIC ::   jpznp      !: Zn in small particles
   INTEGER, PUBLIC ::   jpzng      !: Zn in big particles
   INTEGER, PUBLIC ::   jpznf      !: Zn 
   INTEGER, PUBLIC ::   jpzfd      !: Zn n diatom frustule
   INTEGER, PUBLIC ::   jpszp      !: Zn scavenged on small part
   INTEGER, PUBLIC ::   jpszg      !: Zn scavenged on big part
   INTEGER, PUBLIC ::   jpdmn      !: dissolved Mn
   INTEGER, PUBLIC ::   jpmnn
   INTEGER, PUBLIC ::   jpmnd
   INTEGER, PUBLIC ::   jpmnp
   INTEGER, PUBLIC ::   jpmng
   INTEGER, PUBLIC ::   jpsmn!  Cam Mn Model
