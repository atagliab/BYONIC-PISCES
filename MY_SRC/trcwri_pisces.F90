   ...
   SUBROUTINE trc_wri_pisces
      ...
      ELSE
         DO jn = jp_pcs0, jp_pcs1
            ...
            IF( jn == jpdcu .OR. jn == jpcun .OR. jn == jpcud   &
            &   .OR. jn == jpcup .OR. jn == jpcug .OR. jn == jpscup .OR. jn == jpscug) zfact =1.0e+09
            cltra = TRIM( ctrcnm(jn) )                  ! short title for tracer
            IF( jn == jpdzn .OR. jn == jpznn .OR. jn == jpznd   &
            &   .OR. jn == jpznp .OR. jn == jpzng .OR. jn == jpznf .OR. jn == jpszp &
            &    .OR. jn == jpszg .OR. jn == jpzfd) zfact = 1.0e+09
            IF( jn == jpdco .OR. jn == jpcon .OR. jn == jpcod   &
            &   .OR. jn == jpcop .OR. jn == jpcog .OR. jn == jpsco) zfact =1.0e+09
            IF( jn == jpdmn .OR. jn == jpmnn .OR. jn == jpmnd   &
            &   .OR. jn == jpmnp .OR. jn == jpmng .OR. jn == jpsmn) zfact =1.0e+09
