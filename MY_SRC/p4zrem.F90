      ...
      DO jk = 1, jpkm1
         DO jj = 1, jpj
            DO ji = 1, jpi
               ...
               IF ( ln_zinc ) THEN    !!!! CAm solubilisation of Zn from frustule remin??
               tra(ji,jj,jk,jpznf) = tra(ji,jj,jk,jpznf) - zosil * &
               &       ( trb(ji,jj,jk,jpznf) / ( trb(ji,jj,jk,jpgsi) + rtrn ) )
               tra(ji,jj,jk,jpdzn) = tra(ji,jj,jk,jpdzn) + zosil * &
               &       ( trb(ji,jj,jk,jpznf) / ( trb(ji,jj,jk,jpgsi) + rtrn ) )
               ENDIF
